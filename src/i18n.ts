...
export const translations = {
  en: {
    ...
    defaultLevelHelp: 'Used when starting a new game.',
    themeLabel: 'Theme',
    themeHelp: 'Theme is applied and saved automatically.',
    darkTheme: 'Dark',
    lightTheme: 'Light',
    difficultyLabels: {
      easy: 'Easy',
  ...
  es: {
    ...
    defaultLevel: 'Nivel predeterminado',
    defaultLevelHelp: 'Se usará al iniciar una nueva partida.',
    themeLabel: 'Tema',
    themeHelp: 'El tema se aplica y se guarda automáticamente.',
    darkTheme: 'Oscuro',
    lightTheme: 'Claro',
    difficultyLabels: {
      easy: 'Fácil',
  ...
  fr: {
    ...
    defaultLevelHelp: 'Utilisé au démarrage d’une nouvelle partie.',
    themeLabel: 'Thème',
    themeHelp: 'Le thème est appliqué et enregistré automatiquement.',
    darkTheme: 'Sombre',
    lightTheme: 'Clair',
    difficultyLabels: {
      easy: 'Facile',
  ...
  pt: {
    ...
    defaultLevel: 'Nível padrão',
    defaultLevelHelp: 'Usado ao iniciar um novo jogo.',
    themeLabel: 'Tema',
    themeHelp: 'O tema é aplicado e salvo automaticamente.',
    darkTheme: 'Escuro',
    lightTheme: 'Claro',
    difficultyLabels: {
      easy: 'Fácil',
